...
public class mydb
{
    ...
    public mydb()
    {
        try
        {
         ...
         //   con = @"Data Source=DESKTOP-8TVC6LE;Initial Catalog=college;Persist Security Info=True;User ID=sa;Password=2020";
            con = @"Data Source=DESKTOP-8TVC6LE;Initial Catalog=hall_reservation;Persist Security Info=True;User ID=sa;Password=2020";
